...
export default function ChatUI({ messages, onSend, isTyping = false, onUploadComplete }) {
    ...
    <div className="flex h-full flex-col overflow-hidden bg-white">
      ...
      <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-white via-white to-transparent pt-10 pb-6 px-4">
        <div className="max-w-3xl lg:max-w-[40rem] xl:max-w-[48rem] mx-auto">
          <form 
            onSubmit={submit} 
            className={`relative flex items-end w-full bg-white rounded-3xl shadow-sm transition-all duration-300 py-2 ${
              isFocused 
          ...
          >
            <button
              ...
              className="p-2 ml-1 rounded-lg text-gray-400 hover:bg-gray-100 hover:text-green-500 transition-all duration-200 transform hover:scale-110 mr-2"
            ...
            <textarea
              ...
              disabled={isTyping}
              className={`w-full max-h-[200px] pr-24 bg-transparent border-none focus:ring-0 focus:outline-none outline-none resize-none text-base placeholder-gray-400 transition-all duration-200 ${
                isTyping ? 'text-gray-400 cursor-not-allowed' : 'text-gray-900'
            ...
            <div className="absolute right-3 bottom-3 flex items-center gap-2">
              ...
              <button
                ...
                className="p-2 rounded-lg text-gray-400 hover:bg-gray-100 hover:text-green-500 transition-all duration-200 transform hover:scale-110"
              ...
              >
                <Send className={`w-5 h-5 transition-transform duration-200 ${
                  input.trim() && !isTyping && !isOverLimit ? 'translate-x-0' : ''
                }`} />
              </button>
            </div>
          </form>
